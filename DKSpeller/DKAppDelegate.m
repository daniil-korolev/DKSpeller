...
- (void)buildFactory
{
    self.factory = [TyphoonBlockComponentFactory factoryWithAssemblies:@[ [DKAppFactory assembly] ]];
}
...
- (void)setupWindow
{
    ...
    self.window.rootViewController = [(DKAppFactory *)self.factory rootViewController];
